...
//    public static Account activeAccount;
    ...
    public Account createAccount(String type,
        ...
        switch (type) {
            case "Homeless":
                account = new Homeless(username, password, name, "not_verified", email, id);
                break;
            case "Shelter Volunteer":
                account = new Volunteer(username, password, name, "not_verified", email, id);
                break;
            case "Admin":
                account = new Admin(username, password, name, "not_verified", email, id);
                break;
            default:
