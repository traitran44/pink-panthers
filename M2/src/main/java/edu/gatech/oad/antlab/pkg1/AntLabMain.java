...
public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Hao Dang");
        toPrint += p1.toString("hdang32");
        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Chau Phan");
        toPrint += p2.toString("cphan31");
        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Jeannie Le");
        toPrint += p3.toString("jeannie3");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("My Nguyen");
        toPrint += p4.toString("mnguyen300");
        //Person5 replace P4 with your name
        //and gburdell5 with your gt id
        Person5 p5 = new Person5("Trai Tran");
        toPrint += p5.toString("ttran96");
